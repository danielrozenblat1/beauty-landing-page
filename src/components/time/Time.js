...
const WhoDoesList = ({ isDarkMode }) => {
  ...
  const texts = [
    " השאלה הראשונה שאת שומעת ממתעניינות היא \"כמה זה עולה?\" – במקום \"איך מצטרפים?\"",
    "את מרגישה שהתדמית שלך לא משקפת את המוצר/שירות שלך",
    " כבר יש לך קורס קיים ואת מרגישה שמתפספסות לך 2-3 מתעניינות בחודש שיכלו להפוך ללקוחות",
    " את מתכננת להשיק קורס חדש ורוצה שהמכירה תתחיל עוד לפני שאת מרימה שיחה למתעניינות.",
  " את עייפה מלהסביר שוב ושוב מה מיוחד בשירות שלך – ורוצה שדף אחד יעשה את זה במקומך.",

    " את רוצה להתחיל למכור את השירותים שלך במחירי פרימיום ולא במחירי השוק",
    " את רוצה להתחיל להיתפס כמותג בתחום שלך",
    " את עומדת להשיק קורס דיגיטלי ורוצה שהוא אשכרה יימכר!",
